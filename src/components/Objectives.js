...
const Objectives =() => {
    ...
    return (
        ...
        <div className="container-fluid">
            ...
            <h3>Profile</h3>
            <p>
          I am a banker and freelance software developer with years of experience developing and working with React and Node. I have a demonstrated history of working in an agile
